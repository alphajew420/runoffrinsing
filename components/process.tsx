const steps = [
  {
    ...
    body: "Drop us a line with a couple of pictures. Most quotes come back same-day, often within an hour during business hours.",
  },
  {
    label: "We pick a window",
    body: "We schedule by neighborhood, so we're already in the area on your day. You don't need to be home — outdoor spigots are all we need.",
  },
  {
    label: "We wash. You inspect.",
    body: "Two-person crew, in and out in a few hours for most homes. Walk-through before we pack the truck. If something's off, we fix it on the spot.",
  },
]
